...
val deplacement_gate :
  Classes.solution ->
  Classes.avion array -> (Classes.solution * Classes.changement) array
...
val voisinage :
  Classes.solution ->
  Classes.avion array -> int -> (Classes.solution * Classes.changement) array
...
val maj_delta_voisinage :
  (Classes.solution * Classes.changement) array ->
  (Classes.solution * Classes.changement) array
...
val best_candidate :
  (Classes.solution * Classes.changement) array ->
  int -> int -> (Classes.solution * Classes.changement) * int
